...
<div class="w3-row-padding w3-padding-64 w3-container">
    <div class="w3-content">
        <div>
            <h1>Finanzierung bearbeiten</h1>
            <?= view('validation_feedback', array('sWidth' => '645px')) ?>
            <form action="<?= base_url('/projects/edit_finance_type/' . $aFinanceType['id']) ?>" method="post">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            if ($aFinanceType['type'] == 'allocation') {
                            ...
                            } elseif ($aFinanceType['type'] == 'remedy') {
                                ...
                                <option value="" ';
                                if (!isset($aFinanceType['type']))
                                    echo 'selected';
                                echo ' disabled>Finanzierungstyp wählen</option><option value="1" ';
                                if ($aFinanceType['type'] == 'allocation')
                                    echo 'selected';
                                echo '>Zuwendungsbescheid</option><option value="2" ';
                                if ($aFinanceType['type'] == 'remedy')
                                    echo 'selected';
                                echo '>Mittelabruf</option><option value="3" ';
                                if ($aFinanceType['type'] == 'total')
                                    echo 'selected';
                                echo '>Gesamtfinanzierungsplan</option></select>';
                            }*/
                            ?>
                        </div>
                        <div class="col-md-4">
                            <label for="project_id">Projektname</label>
                            <input name="project_id1" id="project_id1" type="text" class="form-control" disabled
                                   value="<?php
                                   foreach ($aProjects as $aProject) {
                                       if ($aFinanceType['project_id'] == $aProject["id"]) {
                                           echo $aProject["name"];
                                           break;
                                       }
                                   }
                                   ?>">
                            <input name="project_id" id="project_id" type="text" class="form-control" hidden
                                   value="<?php
                                   foreach ($aProjects as $aProject) {
                                       if ($aFinanceType['project_id'] == $aProject["id"]) {
                                           echo $aProject["id"];
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="staff_e12_e15" class="form-control" id="staff_e12_e15"
                                       step="0.01" min="0" value="<?= $aFinanceType['staff_e12_e15'] ?>" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="student_assistant" class="form-control"
                                       id="student_assistant" step="0.01" min="0"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="external_orders" class="form-control" id="external_orders"
                                       step="0.01" min="0" value="<?= $aFinanceType['external_orders'] ?>" required>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">€</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="invest" class="form-control" id="invest" step="0.01"
                                       min="0" value="<?= $aFinanceType['invest'] ?>" required>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">€</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="small_devices" class="form-control" id="small_devices"
                                       step="0.01" min="0" max="800" value="<?= $aFinanceType['small_devices'] ?>"
                                       required>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">€</div>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="business_trips_national" class="form-control"
                                       id="business_trips_national" step="0.01" min="0"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="business_trips_international" class="form-control"
                                       id="business_trips_international" step="0.01" min="0"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="total_staff_expenses" class="form-control"
                                       id="total_staff_expenses" step="0.01" min="0"
                                       value="<?= $aFinanceType['total_staff_expenses'] ?>" readonly>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">€</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="material_expenses" class="form-control"
                                       id="material_expenses" step="0.01" min="0"
                                       value="<?= $aFinanceType['material_expenses'] ?>" readonly>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">€</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="total_expenses" class="form-control" id="total_expenses"
                                       step="0.01" min="0" value="<?= $aFinanceType['total_expenses'] ?>" readonly>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">€</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="total_funding" class="form-control" id="total_funding"
                                       step="0.01" min="0" value="<?= $aFinanceType['total_funding'] ?>" readonly>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">€</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="project_lump_sum" class="form-control" id="project_lump_sum"
                                       step="0.01" min="0" value="<?= $aFinanceType['project_lump_sum'] ?>" readonly>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">€</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="project_lump_sum_percentage" class="form-control"
                                       id="project_lump_sum_percentage" step="0.1" min="0" max="100"
                ...
                <br/>
                <div class="form-group"
                     id="year" <?= $aFinanceType['type'] == 'allocation' ? 'hidden' : '' ?>>
                    <div class="col-md-4">
                        <label for="year">Jahr</label>
                        <input name="year" id="year" type="number" class="form-control" readonly value="<?=$aFinanceType['year']?>">
                    </div>
                </div>
                <br/>
                <div class="w3-card" style="width: 55rem;" <?= $iType == 1 ? '' : 'hidden' ?>>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><strong>1. Jahr</strong><br/>
                            <input type="hidden" id="finance_type_id_1" name="finance_type_id_1"
                                   value="<?= $aTotalFinanceTypes[0]['id'] ?>>">
                            <input type="hidden" id="total_id_1" name="total_id_1"
                                   value="<?= $aTotalFinanceTypes[0]['total_financing_id'] ?>>">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="staff_e12_e15_1" class="form-control"
                                                   id="staff_e12_e15_1"
                                                   step="0.01" min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['staff_e12_e15'] ?>" <?= $iType == 1 ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="staff_e11_1" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['staff_e11'] ?>" <?= $iType == 1 ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="student_assistant_1" class="form-control"
                                                   id="student_assistant_1" step="0.01" min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['student_assistant'] ?>" <?= $iType == 1 ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="external_orders_1" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['external_orders'] ?>" <?= $iType == 1 ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="invest_1" class="form-control" id="invest_1"
                                                   step="0.01"
                                                   min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['invest'] ?>" <?= $iType == 1 ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="small_devices_1" class="form-control"
                                                   ...
                                                   value="<?= $aTotalFinanceTypes[0]['small_devices'] ?>" <?= $iType == 1 ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="business_trips_national_1" class="form-control"
                                                   id="business_trips_national_1" step="0.01" min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['business_trips_national'] ?>" <?= $iType == 1 ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="business_trips_international_1"
                                                   ...
                                                   value="<?= $aTotalFinanceTypes[0]['business_trips_international'] ?>" <?= $iType == 1 ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_staff_expenses_1" class="form-control"
                                                   id="total_staff_expenses_1" step="0.01" min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['total_staff_expenses'] ?>" <?= $iType == 1 ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="material_expenses_1" class="form-control"
                                                   id="material_expenses_1" step="0.01" min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['material_expenses'] ?>" <?= $iType == 1 ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_expenses_1" class="form-control"
                                                   id="total_expenses_1"
                                                   step="0.01" min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['total_expenses'] ?>" <?= $iType == 1 ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_funding_1" class="form-control"
                                                   id="total_funding_1"
                                                   step="0.01" min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['total_funding'] ?>" <?= $iType == 1 ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="project_lump_sum_1" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   value="<?= $aTotalFinanceTypes[0]['project_lump_sum'] ?>" <?= $iType == 1 ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                        ...
                        <li class="list-group-item" <?= ($iType == 1 && count($aYears) >= 2) ? '' : 'hidden' ?>><strong>2.
                                Jahr</strong><br/>
                            <input type="hidden" id="finance_type_id_2" name="finance_type_id_2"
                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['id'] : '' ?>>">
                            <input type="hidden" id="total_id_2" name="total_id_2"
                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['total_financing_id'] : '' ?>>">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="staff_e12_e15_2" class="form-control"
                                                   id="staff_e12_e15_2"
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['staff_e12_e15'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="staff_e11_2" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['staff_e11'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="student_assistant_2" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['student_assistant'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="external_orders_2" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['external_orders'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="invest_2" class="form-control" id="invest_2"
                                                   step="0.01"
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['invest'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="small_devices_2" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   max="800"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['small_devices'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="business_trips_national_2" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['business_trips_national'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="business_trips_international_2"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['business_trips_international'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_staff_expenses_2" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['total_staff_expenses'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="material_expenses_2" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['material_expenses'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_expenses_2" class="form-control"
                                                   id="total_expenses_2"
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['total_expenses'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_funding_2" class="form-control"
                                                   id="total_funding_2"
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['total_funding'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="project_lump_sum_2" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['project_lump_sum'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 2) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="project_lump_sum_percentage_2"
                                                   ...
                                                   value="<?= !empty($aTotalFinanceTypes[1]) ? $aTotalFinanceTypes[1]['project_lump_sum_percentage'] : '0' ?>"
                        ...
                        <li class="list-group-item" <?= ($iType == 1 && count($aYears) >= 3) ? '' : 'hidden' ?>><strong>3.
                                Jahr</strong><br/>
                            <input type="hidden" id="finance_type_id_3" name="finance_type_id_3"
                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['id'] : '' ?>>">
                            <input type="hidden" id="total_id_3" name="total_id_3"
                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['total_financing_id'] : '' ?>>">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="staff_e12_e15_3" class="form-control"
                                                   id="staff_e12_e15_3"
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['staff_e12_e15'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="staff_e11_3" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['staff_e11'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="student_assistant_3" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['student_assistant'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="external_orders_3" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['external_orders'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="invest_3" class="form-control" id="invest_3"
                                                   step="0.01"
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['invest'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="small_devices_3" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   max="800"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['small_devices'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="business_trips_national_3" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['business_trips_national'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="business_trips_international_3"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['business_trips_international'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_staff_expenses_3" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['total_staff_expenses'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="material_expenses_3" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['material_expenses'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_expenses_3" class="form-control"
                                                   id="total_expenses_3"
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['total_expenses'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_funding_3" class="form-control"
                                                   id="total_funding_3"
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['total_funding'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="project_lump_sum_3" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['project_lump_sum'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 3) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="project_lump_sum_percentage_3"
                                                   ...
                                                   value="<?= !empty($aTotalFinanceTypes[2]) ? $aTotalFinanceTypes[2]['project_lump_sum_percentage'] : '0' ?>"
                        ...
                        <li class="list-group-item" <?= ($iType == 1 && count($aYears) >= 4) ? '' : 'hidden' ?>><strong>4.
                                Jahr</strong><br/>
                            <input type="hidden" id="finance_type_id_4" name="finance_type_id_4"
                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['id'] : '' ?>>">
                            <input type="hidden" id="total_id_4" name="total_id_4"
                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['total_financing_id'] : '' ?>>">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="staff_e12_e15_4" class="form-control"
                                                   id="staff_e12_e15_4"
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['staff_e12_e15'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="staff_e11_4" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['staff_e11'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="student_assistant_4" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['student_assistant'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="external_orders_4" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['external_orders'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="invest_4" class="form-control" id="invest_4"
                                                   step="0.01"
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['invest'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="small_devices_4" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   max="800"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['small_devices'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="business_trips_national_4" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['business_trips_national'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="business_trips_international_4"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['business_trips_international'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'required' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_staff_expenses_4" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['total_staff_expenses'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="material_expenses_4" class="form-control"
                                                   ...
                                                   min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['material_expenses'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_expenses_4" class="form-control"
                                                   id="total_expenses_4"
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['total_expenses'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="total_funding_4" class="form-control"
                                                   id="total_funding_4"
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['total_funding'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="project_lump_sum_4" class="form-control"
                                                   ...
                                                   step="0.01" min="0"
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['project_lump_sum'] : '0' ?>" <?= ($iType == 1 && count($aYears) >= 4) ? 'readonly' : '' ?>>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">€</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="project_lump_sum_percentage_4"
                                                   ...
                                                   value="<?= !empty($aTotalFinanceTypes[3]) ? $aTotalFinanceTypes[3]['project_lump_sum_percentage'] : '0' ?>"
                ...
                <div class="form-group" id="remedy_div" <?= ($aFinanceType['type'] == 'remedy') ? '' : 'hidden' ?>>
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input name="submission_date" id="submission_date" class="form-control" type="date"
                                   value="<?= $aFinanceType['submission_date'] ?>" <?= $aFinanceType['type'] == 'remedy' ? 'required' : '' ?>>
                        </div>
                        <div class="col-md-4">
                            <label for="money_receipt_date">Geldeingang am</label>
                            <input name="money_receipt_date" id="money_receipt_date" class="form-control" type="date"
                                   value="<?= $aFinanceType['money_receipt_date'] ?>" <?= $aFinanceType['type'] == 'remedy' ? 'required' : '' ?>>
                        </div>
                    </div>
                </div>

                <input type="hidden" id="remedy_id" name="remedy_id"
                       value="<?= $aFinanceType['remedy_retrieval_id'] ?>>">
                <input type="hidden" id="nr_retrieval_of_year" name="nr_retrieval_of_year"
                       value="<?= $aFinanceType['number_retrieval_of_year'] ?>>">
...
<!--                <br/>-->
                ...
                <a href="<?= base_url('/projects/show_finance_type/' . $aFinanceType['id']) ?>">
